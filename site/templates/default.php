...
<nav class="b-navbar fixed z-50 top-0 left-0 flex md:hidden justify-between w-full px-4 bg-white is-scrolled-up" ob-scrolled>
	...
	<button class="b-navbar__toggle -mx-4 px-4 py-3" ob-toggle="$target: body, class: is-active-nav">
...
<aside class="b-sidebar fixed z-40 top-0 left-0 px-4 h-screen overflow-auto">
